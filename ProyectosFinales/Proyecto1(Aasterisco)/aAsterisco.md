# Documentación detallada del código de visualización A*
...
# Fondo de nodos no utilizados ni seleccionados.
BLANCO = (255, 255, 255)
# paredes u obstáculos
NEGRO = (0, 0, 0)
# líneas de la cuadrícula
GRIS = (128, 128, 128)
# Color para nodos en lista abierta (descubiertos, aún no procesados)
TURQUESA = (64, 224, 208)  
# Color para camino solucionado
AMARILLO = (255, 255, 150)    
# Color para nodos cerrados  (procesado como parte del camino, pero no es parte del camino final) 
ROJO = (255, 0, 0)    
# Color para nodo inicio    
LAVANDA = (220, 208, 255) 
# Color para nodo fin  
LIMA_PASTEL = (216, 255, 168)
# Color de fondo del panel derecho (LISTAS ABIERTA/CERRADA)    
COLOR_PANEL_FONDO = (211, 221, 237)  
# Color para títulos en panel
AZUL = (0, 0, 255)         
...
# Costo acumulado desde inicio 
        self.g = float('inf')  
# Estimación de la distancia al nodo final (heurística)
        self.h = float('inf')  
# Costo total estimado: f = g + h
        self.f = float('inf')  
