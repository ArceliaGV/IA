...
import numpy as np 
#redes neuronales para clasificación, usado como modelo de IA
...
pygame.display.set_caption(" PROYECTO 2: JUEGO PHASER CON REDES NEURONALES")
...
kirby_scaled = pygame.transform.scale(kirby_raw, (42, 42))  # Ajusta el tamaño a algo pequeño y jugable
...
def mostrar_menu():
    ...
    sonido_hover.set_volume(0.5)  # Volumen más bajo para hover
    sonido_hover = None
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.MOUSEBUTTONDOWN:
                ...
                if boton_manual.collidepoint(mouse_pos):
                    modo_auto = False
                    datos_modelo.clear()  # Limpiar datos al cambiar a modo manual
                  ...
                  #  datos_modelo.clear()  # Limpiar datos antes de entrenar
                    entrenar_modelo()
                    modo_auto = True
                    menu_activo = False
...
def reiniciar_juego():
    ...
    mostrar_menu()
    #---------------------------------------------------------------------------- 
# INICIALIZACION DEL MODELO DE RED NEURONAL -------------------
